  ...
  return (
    <div className="h-full flex flex-col">
      <header className="h-14 flex items-center justify-between px-6 border-b border-[#1e1e24] shrink-0">
        <div className="flex items-center gap-3">
          <h2 className="text-[15px] font-medium text-white">Teams</h2>
          <span className="text-[11px] text-zinc-600 bg-zinc-900 px-2 py-0.5 rounded-full">{teams.length} configurados</span>
        </div>
      </header>
