...
scriptwriter = Agent(
    ...
    instructions=[
        ...
        "5. Output BOTH: a human-readable summary AND the VideoStoryboard JSON",
        "",
        "## Script Rules",
        ...
        "You MUST always end your response with a JSON code block containing the",
        "complete VideoStoryboard. This JSON is consumed by Remotion to render the",
        "video. The human-readable summary comes first, then the JSON at the end.",
        "",
        "```json",
        "{",
        '  "title": "Video title",',
        ...
        "```",
        "",
        "NEVER skip the JSON block. It is required for video production.",
    ],
    db=db,
    learning=_learning,
    add_datetime_to_context=True,
